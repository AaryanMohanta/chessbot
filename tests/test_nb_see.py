...
def test_defended_capture_by_cheaper_piece_loses():
    ...
    trading a knight for a pawn nets -220."""
...
def test_overdefended_capture_loses_after_full_exchange():
    ...
    the knight but the queen recaptures the rook: 320 - 500 = -180."""
